		...
		<div class="table-responsive col-sm-10">
			<table class="table table-condensed">
				...
				<tr>
					...
					<td>${o.orderDate}</td>
					<%
						com.YangZhihao.model.Order o=(com.YangZhihao.model.Order)pageContext.findAttribute("o");
						int userId=o.getCustomerId();
						java.sql.Connection con=(java.sql.Connection)application.getAttribute("con");
						com.YangZhihao.dao.Userdao userDao=new com.YangZhihao.dao.Userdao();
					...
					<td class="cart_total">${o.paymentId}
						<%
							...
							String paymentType=com.YangZhihao.model.Payment.findByPaymentId(con,n);
						%>
